...
//      init views
        ...
        var deleteView = mc.makeGraphics(PlayerViewStyle.NAME_EDITOR_DELETE);
        var _name:TextField = cast mc.getChildByName(PlayerViewStyle.NAME_NAME);
...
//      init hitareas
        deleteHitArea = mc.makeTapZone(PlayerViewStyle.NAME_EDITOR_DELETE_HITAREA);
