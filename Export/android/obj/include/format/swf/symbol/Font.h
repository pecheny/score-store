...
class HXCPP_CLASS_ATTRIBUTES  Font_obj : public hx::Object{
	...
	public:
		...
		virtual Void renderGlyph( ::flash::display::Graphics graphics,int index,::flash::geom::Matrix matrix);
		Dynamic renderGlyph_dyn();

		virtual Float renderCharacter( ::flash::display::Graphics graphics,int code,::flash::geom::Matrix matrix);
