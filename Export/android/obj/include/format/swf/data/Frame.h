...
class HXCPP_CLASS_ATTRIBUTES  Frame_obj : public hx::Object{
	...
	public:
		...
		virtual Void place( int symbolID,::format::swf::symbol::Symbol symbol,int depth,::flash::geom::Matrix matrix,::flash::geom::ColorTransform colorTransform,Dynamic ratio,::String name,Array< ::Dynamic > filters);
		Dynamic place_dyn();

		virtual Void move( int depth,::flash::geom::Matrix matrix,::flash::geom::ColorTransform colorTransform,Dynamic ratio);
		Dynamic move_dyn();
