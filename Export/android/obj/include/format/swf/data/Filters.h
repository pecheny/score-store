...
class HXCPP_CLASS_ATTRIBUTES  Filters_obj : public hx::Object{
	...
	public:
		...
		static ::flash::filters::BitmapFilter createBevelFilter( ::format::swf::data::SWFStream stream);
		static Dynamic createBevelFilter_dyn();

		static ::flash::filters::BitmapFilter createBlurFilter( ::format::swf::data::SWFStream stream);
		static Dynamic createBlurFilter_dyn();

		static ::flash::filters::BitmapFilter createColorMatrixFilter( ::format::swf::data::SWFStream stream);
		static Dynamic createColorMatrixFilter_dyn();

		static ::flash::filters::BitmapFilter createConvolutionFilter( ::format::swf::data::SWFStream stream);
		static Dynamic createConvolutionFilter_dyn();

		static ::flash::filters::BitmapFilter createDropShadowFilter( ::format::swf::data::SWFStream stream);
		static Dynamic createDropShadowFilter_dyn();

		static ::flash::filters::BitmapFilter createGlowFilter( ::format::swf::data::SWFStream stream);
		static Dynamic createGlowFilter_dyn();

		static ::flash::filters::BitmapFilter createGradientBevelFilter( ::format::swf::data::SWFStream stream);
		static Dynamic createGradientBevelFilter_dyn();

		static ::flash::filters::BitmapFilter createGradientGlowFilter( ::format::swf::data::SWFStream stream);
