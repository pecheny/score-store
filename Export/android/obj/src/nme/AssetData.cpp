...
Void AssetData_obj::initialize( ){
{
		...
		if ((!(::nme::AssetData_obj::initialized))){
			...
			HX_STACK_LINE(25)
			::nme::AssetData_obj::path->set(HX_CSTRING("assets/CounterAssets.fla"),HX_CSTRING("assets_counterassets_fla"));
			HX_STACK_LINE(26)
			{
				HX_STACK_LINE(26)
				...
				HX_STACK_LINE(26)
				::nme::AssetData_obj::type->set(HX_CSTRING("assets/CounterAssets.fla"),value);
			}
			HX_STACK_LINE(27)
			::nme::AssetData_obj::path->set(HX_CSTRING("assets/CounterAssets.swc"),HX_CSTRING("assets_counterassets_swc"));
			HX_STACK_LINE(28)
			{
				HX_STACK_LINE(28)
				::openfl::AssetType value = ::Reflect_obj::field(hx::ClassOf< ::openfl::AssetType >(),HX_CSTRING("binary").toUpperCase());		HX_STACK_VAR(value,"value");
				HX_STACK_LINE(28)
				::nme::AssetData_obj::type->set(HX_CSTRING("assets/CounterAssets.swc"),value);
			}
			HX_STACK_LINE(29)
			::nme::AssetData_obj::path->set(HX_CSTRING("assets/CounterAssets.swf"),HX_CSTRING("assets_counterassets_swf"));
			HX_STACK_LINE(30)
			{
				HX_STACK_LINE(30)
				::openfl::AssetType value = ::Reflect_obj::field(hx::ClassOf< ::openfl::AssetType >(),HX_CSTRING("binary").toUpperCase());		HX_STACK_VAR(value,"value");
				HX_STACK_LINE(30)
				::nme::AssetData_obj::type->set(HX_CSTRING("assets/CounterAssets.swf"),value);
			}
			HX_STACK_LINE(31)
			::nme::AssetData_obj::path->set(HX_CSTRING("assets/Droid-Sans.zip"),HX_CSTRING("assets_droid_sans_zip"));
			HX_STACK_LINE(32)
			{
				HX_STACK_LINE(32)
				::openfl::AssetType value = ::Reflect_obj::field(hx::ClassOf< ::openfl::AssetType >(),HX_CSTRING("binary").toUpperCase());		HX_STACK_VAR(value,"value");
				HX_STACK_LINE(32)
				::nme::AssetData_obj::type->set(HX_CSTRING("assets/Droid-Sans.zip"),value);
			}
			HX_STACK_LINE(33)
			::nme::AssetData_obj::path->set(HX_CSTRING("assets/DroidSans-Bold.ttf"),HX_CSTRING("assets_droidsans_bold_ttf"));
			HX_STACK_LINE(34)
			{
				HX_STACK_LINE(34)
				...
				HX_STACK_LINE(34)
				::nme::AssetData_obj::type->set(HX_CSTRING("assets/DroidSans-Bold.ttf"),value);
			}
			HX_STACK_LINE(35)
			::nme::AssetData_obj::path->set(HX_CSTRING("assets/DroidSans.ttf"),HX_CSTRING("assets_droidsans_ttf"));
			HX_STACK_LINE(36)
			{
				HX_STACK_LINE(36)
				::openfl::AssetType value = ::Reflect_obj::field(hx::ClassOf< ::openfl::AssetType >(),HX_CSTRING("font").toUpperCase());		HX_STACK_VAR(value,"value");
				HX_STACK_LINE(36)
				::nme::AssetData_obj::type->set(HX_CSTRING("assets/DroidSans.ttf"),value);
			}
			HX_STACK_LINE(39)
