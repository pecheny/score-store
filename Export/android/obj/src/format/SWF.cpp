...
Void SWF_obj::__construct(::flash::utils::ByteArray data)
{
HX_STACK_PUSH("SWF::new","format/SWF.hx",50);
{
	...
	HX_STACK_LINE(58)
	::flash::geom::Rectangle dimensions = this->stream->readRect();		HX_STACK_VAR(dimensions,"dimensions");
	HX_STACK_LINE(59)
...
hx::ObjectPtr< SWF_obj > SWF_obj::__new(::flash::utils::ByteArray data)
...
::flash::display::BitmapData SWF_obj::getBitmapData( ::String className){
...
::flash::display::SimpleButton SWF_obj::createButton( ::String className){
...
Dynamic SWF_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 10:
		...
		if (HX_FIELD_EQ(inName,"jpegTables") ) { jpegTables=inValue.Cast< ::flash::utils::ByteArray >(); return inValue; }
		break;
	case 15:
