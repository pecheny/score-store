...
{
	HX_STACK_LINE(35)
	this->textFormat = ::flash::text::TextFormat_obj::__new(null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
	HX_STACK_LINE(37)
...
{
							HX_STACK_LINE(69)
							this->textFormat->font = font->getFontName();
						}
					}
					;break;
					default: {
...
Void EditText_obj::apply( ::flash::text::TextField textField){
{
		...
		if ((this->readOnly)){
			HX_STACK_LINE(147)
			textField->set_type(::flash::text::TextFieldType_obj::DYNAMIC);
		}
		else{
			HX_STACK_LINE(151)
			textField->set_type(::flash::text::TextFieldType_obj::INPUT);
		}
		HX_STACK_LINE(157)
		if ((this->autoSize)){
			HX_STACK_LINE(157)
			textField->set_autoSize(::flash::text::TextFieldAutoSize_obj::CENTER);
		}
		else{
			HX_STACK_LINE(161)
			textField->set_autoSize(::flash::text::TextFieldAutoSize_obj::NONE);
		}
		HX_STACK_LINE(167)
