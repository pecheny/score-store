...
Void Bitmap_obj::__construct(::format::swf::data::SWFStream stream,bool lossless,int version,::flash::utils::ByteArray jpegTables)
{
HX_STACK_PUSH("Bitmap::new","format/swf/symbol/Bitmap.hx",27);
{
	...
	if ((lossless)){
		...
		HX_STACK_LINE(57)
		::flash::utils::ByteArray buffer = stream->readFlashBytes(stream->getBytesLeft());		HX_STACK_VAR(buffer,"buffer");
		HX_STACK_LINE(58)
		...
		if (((format == (int)3))){
			...
			HX_STACK_LINE(72)
			{
				...
				while(((_g < tableSize))){
					...
					struct _Function_5_1{
						inline static int Block( ::flash::utils::ByteArray &buffer){
							HX_STACK_PUSH("*::closure","format/swf/symbol/Bitmap.hx",74);
							{
								HX_STACK_LINE(74)
								int value = (  (((buffer->position < buffer->length))) ? int(buffer->b->__get((buffer->position)++)) : int(buffer->__throwEOFi()) );		HX_STACK_VAR(value,"value");
								HX_STACK_LINE(74)
			...
			HX_STACK_LINE(91)
			::flash::utils::ByteArray imageData = ::flash::utils::ByteArray_obj::__new(null());		HX_STACK_VAR(imageData,"imageData");
			HX_STACK_LINE(92)
		...
		HX_STACK_LINE(111)
		this->bitmapData = ::flash::display::BitmapData_obj::__new(width,height,transparent,null(),null());
		HX_STACK_LINE(112)
		this->bitmapData->setPixels(::flash::geom::Rectangle_obj::__new((int)0,(int)0,width,height),buffer);
	}
	else{
		HX_STACK_LINE(116)
		::flash::utils::ByteArray buffer = null();		HX_STACK_VAR(buffer,"buffer");
		HX_STACK_LINE(117)
		::flash::utils::ByteArray alpha = null();		HX_STACK_VAR(alpha,"alpha");
		HX_STACK_LINE(119)
		...
		HX_STACK_LINE(148)
		this->bitmapData = ::flash::display::BitmapData_obj::loadFromHaxeBytes(buffer,alpha);
		HX_STACK_LINE(150)
...
hx::ObjectPtr< Bitmap_obj > Bitmap_obj::__new(::format::swf::data::SWFStream stream,bool lossless,int version,::flash::utils::ByteArray jpegTables)
...
::flash::display::BitmapData Bitmap_obj::createWithAlpha( ::flash::display::BitmapData data,::flash::utils::ByteArray alpha){
	HX_STACK_PUSH("Bitmap::createWithAlpha","format/swf/symbol/Bitmap.hx",164);
	HX_STACK_THIS(this);
	HX_STACK_ARG(data,"data");
	HX_STACK_ARG(alpha,"alpha");
	HX_STACK_LINE(166)
	::flash::display::BitmapData alphaBitmap = ::flash::display::BitmapData_obj::__new(data->get_width(),data->get_height(),true,null(),null());		HX_STACK_VAR(alphaBitmap,"alphaBitmap");
	HX_STACK_LINE(167)
