	...
	while((true)){
		...
		if ((!(edge))){
			...
			if ((moveTo)){
				...
				Void run(::flash::display::Graphics g){
			...
			if ((stream->readBool())){
				...
				if (((currentLine > (int)0))){
					...
					HX_BEGIN_LOCAL_FUNC_S4(hx::LocalFunc,_Function_5_1,Array< Float >,cx,Array< Float >,cy,Array< Float >,px,Array< Float >,py)
					Void run(::flash::display::Graphics g){
					...
					HX_STACK_LINE(273)
					edges->__Field(HX_CSTRING("push"),true)( Dynamic(new _Function_5_1(cx,cy,px,py)));
				}
				HX_STACK_LINE(281)
				if (((currentFill0 > (int)0))){
					HX_STACK_LINE(281)
...
bool Shape_obj::render( ::flash::display::Graphics graphics){
	...
	HX_STACK_LINE(597)
	{
		...
		while(((_g < count))){
			...
			if (((version >= (int)4))){
				...
				HX_STACK_LINE(613)
				Array< Float > miter = Array_obj< Float >::__new().Add((  (((joints->__get((int)0).StaticCast< ::flash::display::JointStyle >() == ::flash::display::JointStyle_obj::MITER))) ? Float((Float(stream->readDepth()) / Float(256.0))) : Float((int)1) ));		HX_STACK_VAR(miter,"miter");
				HX_STACK_LINE(614)
				...
				if ((hasFill)){
					...
					if (((((int(fill) & int((int)16))) != (int)0))){
						...
						HX_STACK_LINE(645)
						Array< ::Dynamic > type = Array_obj< ::Dynamic >::__new().Add((  (((fill == ::format::swf::symbol::Shape_obj::ftLinear))) ? ::flash::display::GradientType(::flash::display::GradientType_obj::LINEAR) : ::flash::display::GradientType(::flash::display::GradientType_obj::RADIAL) ));		HX_STACK_VAR(type,"type");

						HX_BEGIN_LOCAL_FUNC_S14(hx::LocalFunc,_Function_6_1,Array< Float >,width,Array< Float >,focus,Array< ::Dynamic >,alphas,Array< Float >,miter,Array< ::Dynamic >,spread,Array< ::Dynamic >,interp,Array< ::Dynamic >,joints,Array< ::Dynamic >,colors,Array< ::Dynamic >,matrix,Array< ::Dynamic >,ratios,Array< ::Dynamic >,scale,Array< ::Dynamic >,type,Array< ::Dynamic >,startCaps,Array< bool >,pixelHint)
						Void run(::flash::display::Graphics g){
							HX_STACK_PUSH("*::_Function_6_1","format/swf/symbol/Shape.hx",647);
							HX_STACK_ARG(g,"g");
							{
								HX_STACK_LINE(649)
								g->lineStyle(width->__get((int)0),(int)0,(int)1,pixelHint->__get((int)0),scale->__get((int)0).StaticCast< ::flash::display::LineScaleMode >(),startCaps->__get((int)0).StaticCast< ::flash::display::CapsStyle >(),joints->__get((int)0).StaticCast< ::flash::display::JointStyle >(),miter->__get((int)0));
								HX_STACK_LINE(650)
								g->lineGradientStyle(type->__get((int)0).StaticCast< ::flash::display::GradientType >(),colors->__get((int)0).StaticCast< Array< int > >(),alphas->__get((int)0).StaticCast< Array< Float > >(),ratios->__get((int)0).StaticCast< Array< int > >(),matrix->__get((int)0).StaticCast< ::flash::geom::Matrix >(),spread->__get((int)0).StaticCast< ::flash::display::SpreadMethod >(),interp->__get((int)0).StaticCast< ::flash::display::InterpolationMethod >(),focus->__get((int)0));
							}
							return null();
						}
						HX_END_LOCAL_FUNC1((void))
						...
						HX_STACK_LINE(647)
						result->__Field(HX_CSTRING("push"),true)( Dynamic(new _Function_6_1(width,focus,alphas,miter,spread,interp,joints,colors,matrix,ratios,scale,type,startCaps,pixelHint)));
					}
					else{
						HX_STACK_LINE(654)
					...
					HX_BEGIN_LOCAL_FUNC_S8(hx::LocalFunc,_Function_5_1,Array< Float >,width,Array< Float >,miter,Array< Float >,A,Array< ::Dynamic >,joints,Array< ::Dynamic >,scale,Array< int >,color,Array< ::Dynamic >,startCaps,Array< bool >,pixelHint)
					Void run(::flash::display::Graphics g){
						HX_STACK_PUSH("*::_Function_5_1","format/swf/symbol/Shape.hx",662);
						HX_STACK_ARG(g,"g");
						{
							HX_STACK_LINE(662)
							g->lineStyle(width->__get((int)0),color->__get((int)0),A->__get((int)0),pixelHint->__get((int)0),scale->__get((int)0).StaticCast< ::flash::display::LineScaleMode >(),startCaps->__get((int)0).StaticCast< ::flash::display::CapsStyle >(),joints->__get((int)0).StaticCast< ::flash::display::JointStyle >(),miter->__get((int)0));
						}
						return null();
					}
					HX_END_LOCAL_FUNC1((void))
					...
					HX_STACK_LINE(660)
					result->__Field(HX_CSTRING("push"),true)( Dynamic(new _Function_5_1(width,miter,A,joints,scale,color,startCaps,pixelHint)));
				}
			}
			else{
				HX_STACK_LINE(672)
				...
				HX_BEGIN_LOCAL_FUNC_S3(hx::LocalFunc,_Function_4_1,Array< Float >,width,Array< int >,RGB,Array< Float >,A)
				Void run(::flash::display::Graphics g){
				...
				HX_STACK_LINE(678)
				result->__Field(HX_CSTRING("push"),true)( Dynamic(new _Function_4_1(width,RGB,A)));
			}
		}
	}
	HX_STACK_LINE(688)
		...
		while(((_g < count))){
			...
			if (((fill == ::format::swf::symbol::Shape_obj::ftSolid))){
				...
				if (((bool((bool((fill == ::format::swf::symbol::Shape_obj::ftLinear)) || bool((fill == ::format::swf::symbol::Shape_obj::ftRadial)))) || bool((fill == ::format::swf::symbol::Shape_obj::ftRadialF))))){
					...
					HX_BEGIN_LOCAL_FUNC_S8(hx::LocalFunc,_Function_5_1,Array< Float >,focus,Array< ::Dynamic >,alphas,Array< ::Dynamic >,spread,Array< ::Dynamic >,interp,Array< ::Dynamic >,colors,Array< ::Dynamic >,matrix,Array< ::Dynamic >,ratios,Array< ::Dynamic >,type)
					Void run(::flash::display::Graphics g){
						HX_STACK_PUSH("*::_Function_5_1","format/swf/symbol/Shape.hx",467);
						HX_STACK_ARG(g,"g");
						{
							HX_STACK_LINE(467)
							g->beginGradientFill(type->__get((int)0).StaticCast< ::flash::display::GradientType >(),colors->__get((int)0).StaticCast< Array< int > >(),alphas->__get((int)0).StaticCast< Array< Float > >(),ratios->__get((int)0).StaticCast< Array< int > >(),matrix->__get((int)0).StaticCast< ::flash::geom::Matrix >(),spread->__get((int)0).StaticCast< ::flash::display::SpreadMethod >(),interp->__get((int)0).StaticCast< ::flash::display::InterpolationMethod >(),focus->__get((int)0));
						}
						return null();
					}
					HX_END_LOCAL_FUNC1((void))
					...
					HX_STACK_LINE(467)
					result->__Field(HX_CSTRING("push"),true)( Dynamic(new _Function_5_1(focus,alphas,spread,interp,colors,matrix,ratios,type)));
				}
				else{
					HX_STACK_LINE(473)
					if (((bool((bool((bool((fill == ::format::swf::symbol::Shape_obj::ftBitmapRepeatSmooth)) || bool((fill == ::format::swf::symbol::Shape_obj::ftBitmapClippedSmooth)))) || bool((fill == ::format::swf::symbol::Shape_obj::ftBitmapRepeat)))) || bool((fill == ::format::swf::symbol::Shape_obj::ftBitmapClipped))))){
						...
						Array< ::Dynamic > matrix = Array_obj< ::Dynamic >::__new().Add(stream->readMatrix());		HX_STACK_VAR(matrix,"matrix");
						HX_STACK_LINE(484)
						hx::MultEq(matrix->__get((int)0).StaticCast< ::flash::geom::Matrix >()->a,0.05);
						HX_STACK_LINE(485)
						hx::MultEq(matrix->__get((int)0).StaticCast< ::flash::geom::Matrix >()->b,0.05);
						HX_STACK_LINE(486)
						hx::MultEq(matrix->__get((int)0).StaticCast< ::flash::geom::Matrix >()->c,0.05);
						HX_STACK_LINE(487)
						hx::MultEq(matrix->__get((int)0).StaticCast< ::flash::geom::Matrix >()->d,0.05);
						HX_STACK_LINE(489)
						stream->alignBits();
						HX_STACK_LINE(491)
						...
						if (((id->__get((int)0) != (int)65535))){
							...
							HX_STACK_LINE(498)
							{
								...
								switch((_switch_1)->GetIndex()){
									case 3: {
										::format::swf::symbol::Bitmap data = _switch_1->__Param(0);
{
											HX_STACK_LINE(500)
						...
						if (((bitmap->__get((int)0).StaticCast< ::flash::display::BitmapData >() != null()))){
							...
							HX_BEGIN_LOCAL_FUNC_S4(hx::LocalFunc,_Function_7_1,Array< bool >,repeat,Array< ::Dynamic >,matrix,Array< ::Dynamic >,bitmap,Array< bool >,smooth)
							Void run(::flash::display::Graphics g){
								HX_STACK_PUSH("*::_Function_7_1","format/swf/symbol/Shape.hx",519);
								HX_STACK_ARG(g,"g");
								{
									HX_STACK_LINE(519)
									g->beginBitmapFill(bitmap->__get((int)0).StaticCast< ::flash::display::BitmapData >(),matrix->__get((int)0).StaticCast< ::flash::geom::Matrix >(),repeat->__get((int)0),smooth->__get((int)0));
								}
								return null();
							}
							HX_END_LOCAL_FUNC1((void))
							...
							HX_STACK_LINE(519)
							result->__Field(HX_CSTRING("push"),true)( Dynamic(new _Function_7_1(repeat,matrix,bitmap,smooth)));
						}
						else{
							HX_STACK_LINE(529)
							...
							HX_BEGIN_LOCAL_FUNC_S7(hx::LocalFunc,_Function_7_1,Array< bool >,repeat,Array< ::Dynamic >,s,Array< ::Dynamic >,matrix,Array< ::Dynamic >,bitmap,Array< ::Dynamic >,me,Array< bool >,smooth,Array< int >,id)
							Void run(::flash::display::Graphics g){
										...
										if (((id->__get((int)0) != (int)65535))){
											...
											HX_STACK_LINE(538)
											{
												...
												switch((_switch_2)->GetIndex()){
													case 3: {
														::format::swf::symbol::Bitmap data = _switch_2->__Param(0);
{
															HX_STACK_LINE(540)
															bitmap[(int)0] = data->bitmapData;
														}
							...
							HX_STACK_LINE(532)
							result->__Field(HX_CSTRING("push"),true)( Dynamic(new _Function_7_1(repeat,s,matrix,bitmap,me,smooth,id)));
						}
					}
					else{
						HX_STACK_LINE(571)
...
Void Shape_obj::flushCommands( Dynamic edges,Array< ::Dynamic > fills){
{
		...
		while(((left > (int)0))){
			...
			HX_BEGIN_LOCAL_FUNC_S2(hx::LocalFunc,_Function_2_1,Array< Float >,my,Array< Float >,mx)
			Void run(::flash::display::Graphics gfx){
			...
			HX_STACK_LINE(329)
			this->commands->__Field(HX_CSTRING("push"),true)( Dynamic(new _Function_2_1(my,mx)));
			HX_STACK_LINE(335)
...
Dynamic Shape_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 10:
		...
		if (HX_FIELD_EQ(inName,"edgeBounds") ) { edgeBounds=inValue.Cast< ::flash::geom::Rectangle >(); return inValue; }
		break;
	case 12:
