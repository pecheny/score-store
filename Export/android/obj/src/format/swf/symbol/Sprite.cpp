...
Void Sprite_obj::placeObject( ::format::swf::data::SWFStream stream,int version){
{
		...
		if (((version == (int)1))){
			...
			int depth = stream->readDepth();		HX_STACK_VAR(depth,"depth");
			HX_STACK_LINE(65)
			::flash::geom::Matrix matrix = stream->readMatrix();		HX_STACK_VAR(matrix,"matrix");
			HX_STACK_LINE(67)
			::flash::geom::ColorTransform colorTransform = null();		HX_STACK_VAR(colorTransform,"colorTransform");
			HX_STACK_LINE(69)
			...
			if (((bool((version == (int)2)) || bool((version == (int)3))))){
				...
				HX_STACK_LINE(119)
				::flash::geom::Matrix matrix = (  ((hasMatrix)) ? ::flash::geom::Matrix(stream->readMatrix()) : ::flash::geom::Matrix(null()) );		HX_STACK_VAR(matrix,"matrix");
				HX_STACK_LINE(120)
				::flash::geom::ColorTransform colorTransform = (  ((hasColorTransform)) ? ::flash::geom::ColorTransform(stream->readColorTransform(true)) : ::flash::geom::ColorTransform(null()) );		HX_STACK_VAR(colorTransform,"colorTransform");
				HX_STACK_LINE(121)
				...
				if ((hasBlendMode)){
					struct _Function_4_1{
						inline static ::flash::display::BlendMode Block( ::format::swf::data::SWFStream &stream){
							HX_STACK_PUSH("*::closure","format/swf/symbol/Sprite.hx",141);
							{
								HX_STACK_LINE(141)
								int _g = stream->readByte();		HX_STACK_VAR(_g,"_g");
								struct _Function_5_1{
									inline static ::flash::display::BlendMode Block( int &_g){
										HX_STACK_PUSH("*::closure","format/swf/symbol/Sprite.hx",141);
										{
											HX_STACK_LINE(141)
											switch( (int)(_g)){
												case (int)2: {
													HX_STACK_LINE(142)
													return ::flash::display::BlendMode_obj::LAYER;
												}
												;break;
												case (int)3: {
													HX_STACK_LINE(143)
													return ::flash::display::BlendMode_obj::MULTIPLY;
												}
												;break;
												case (int)4: {
													HX_STACK_LINE(144)
													return ::flash::display::BlendMode_obj::SCREEN;
												}
												;break;
												case (int)5: {
													HX_STACK_LINE(145)
													return ::flash::display::BlendMode_obj::LIGHTEN;
												}
												;break;
												case (int)6: {
													HX_STACK_LINE(146)
													return ::flash::display::BlendMode_obj::DARKEN;
												}
												;break;
												case (int)7: {
													HX_STACK_LINE(147)
													return ::flash::display::BlendMode_obj::DIFFERENCE;
												}
												;break;
												case (int)8: {
													HX_STACK_LINE(148)
													return ::flash::display::BlendMode_obj::ADD;
												}
												;break;
												case (int)9: {
													HX_STACK_LINE(149)
													return ::flash::display::BlendMode_obj::SUBTRACT;
												}
												;break;
												case (int)10: {
													HX_STACK_LINE(150)
													return ::flash::display::BlendMode_obj::INVERT;
												}
												;break;
												case (int)11: {
													HX_STACK_LINE(151)
													return ::flash::display::BlendMode_obj::ALPHA;
												}
												;break;
												case (int)12: {
													HX_STACK_LINE(152)
													return ::flash::display::BlendMode_obj::ERASE;
												}
												;break;
												case (int)13: {
													HX_STACK_LINE(153)
													return ::flash::display::BlendMode_obj::OVERLAY;
												}
												;break;
												case (int)14: {
													HX_STACK_LINE(154)
													return ::flash::display::BlendMode_obj::HARDLIGHT;
												}
												;break;
												default: {
													HX_STACK_LINE(155)
													return ::flash::display::BlendMode_obj::NORMAL;
												}
											}
										}
										return null();
...
Dynamic Sprite_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 9:
		...
		if (HX_FIELD_EQ(inName,"blendMode") ) { blendMode=inValue.Cast< ::flash::display::BlendMode >(); return inValue; }
		break;
	case 10:
