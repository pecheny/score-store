		...
		while((!(edgeFound))){
			...
			HX_STACK_LINE(282)
			{
				...
				switch((_switch_1)->GetIndex()){
					case 1: {
						Float meY = _switch_1->__Param(1);
						Float meX = _switch_1->__Param(0);
{
							HX_STACK_LINE(286)
							x[(int)0] = meX;
							HX_STACK_LINE(287)
					...
					;break;
					case 2: {
						Float meY = _switch_1->__Param(3);
						Float meX = _switch_1->__Param(2);
						Float meCY = _switch_1->__Param(1);
						Float meCX = _switch_1->__Param(0);
{
							HX_STACK_LINE(307)
							cx[(int)0] = meCX;
							HX_STACK_LINE(308)
						...
						Float meCX = _switch_1->__Param(0);
{
					...
					;break;
					case 0: {
						Dynamic command = _switch_1->__Param(0);
{
							HX_STACK_LINE(326)
							this->commands->__Field(HX_CSTRING("push"),true)(command);
							HX_STACK_LINE(327)
							edgeFound = false;
						}
					}
		...
		if ((!(edge))){
			...
			HX_BEGIN_LOCAL_FUNC_S4(hx::LocalFunc,_Function_3_1,Array< Float >,x,Array< Float >,px,Array< Float >,y,Array< Float >,py)
			Void run(::flash::display::Graphics g,Float f){
			...
			HX_STACK_LINE(348)
			this->commands->__Field(HX_CSTRING("push"),true)( Dynamic(new _Function_3_1(x,px,y,py)));
		}
		else{
			HX_STACK_LINE(354)
			if ((stream->readBool())){
				...
				if ((!(isLine))){
					...
					HX_BEGIN_LOCAL_FUNC_S8(hx::LocalFunc,_Function_5_1,Array< Float >,cy2,Array< Float >,cx,Array< Float >,cy,Array< Float >,x,Array< Float >,px,Array< Float >,y,Array< Float >,cx2,Array< Float >,py)
					Void run(::flash::display::Graphics g,Float f){
					...
					HX_STACK_LINE(387)
					this->commands->__Field(HX_CSTRING("push"),true)( Dynamic(new _Function_5_1(cy2,cx,cy,x,px,y,cx2,py)));
				}
				else{

					HX_BEGIN_LOCAL_FUNC_S4(hx::LocalFunc,_Function_5_1,Array< Float >,x,Array< Float >,px,Array< Float >,y,Array< Float >,py)
					Void run(::flash::display::Graphics g,Float f){
					...
					HX_STACK_LINE(393)
					this->commands->__Field(HX_CSTRING("push"),true)( Dynamic(new _Function_5_1(x,px,y,py)));
				}
			}
			else{
				HX_STACK_LINE(407)
				...
				HX_BEGIN_LOCAL_FUNC_S8(hx::LocalFunc,_Function_4_1,Array< Float >,cy2,Array< Float >,cx,Array< Float >,cy,Array< Float >,x,Array< Float >,px,Array< Float >,y,Array< Float >,cx2,Array< Float >,py)
				Void run(::flash::display::Graphics g,Float f){
				...
				HX_STACK_LINE(419)
				this->commands->__Field(HX_CSTRING("push"),true)( Dynamic(new _Function_4_1(cy2,cx,cy,x,px,y,cx2,py)));
			}
		}
	}
	HX_STACK_LINE(431)
		...
		::format::swf::symbol::MorphEdge edge = __it->next();
		{
			HX_STACK_LINE(431)
			{
				...
				switch((_switch_2)->GetIndex()){
					case 0: {
						Dynamic command = _switch_2->__Param(0);
{
							HX_STACK_LINE(435)
							this->commands->__Field(HX_CSTRING("push"),true)(command);
						}
...
bool MorphShape_obj::render( ::flash::display::Graphics graphics,Float f){
	...
	HX_STACK_LINE(695)
	{
		...
		while(((_g < numStyles))){
			...
			if (((version == (int)1))){
				...
				HX_BEGIN_LOCAL_FUNC_S6(hx::LocalFunc,_Function_4_1,Array< int >,RGB1,Array< Float >,w1,Array< int >,RGB0,Array< Float >,A0,Array< Float >,A1,Array< Float >,w0)
				Void run(::flash::display::Graphics g,Float f){
				...
				HX_STACK_LINE(708)
				result->__Field(HX_CSTRING("push"),true)( Dynamic(new _Function_4_1(RGB1,w1,RGB0,A0,A1,w0)));
			}
			else{
				HX_STACK_LINE(718)
				stream->alignBits();
				...
				HX_STACK_LINE(730)
				::flash::display::CapsStyle endCaps = stream->readCapsStyle();		HX_STACK_VAR(endCaps,"endCaps");
				HX_STACK_LINE(732)
				Array< Float > miter = Array_obj< Float >::__new().Add(1.0);		HX_STACK_VAR(miter,"miter");
				HX_STACK_LINE(734)
				if (((joints->__get((int)0).StaticCast< ::flash::display::JointStyle >() == ::flash::display::JointStyle_obj::MITER))){
					HX_STACK_LINE(734)
				...
				if ((!(hasFill))){
					...
					HX_BEGIN_LOCAL_FUNC_S11(hx::LocalFunc,_Function_5_1,Array< int >,c1,Array< Float >,miter,Array< Float >,w1,Array< ::Dynamic >,joints,Array< int >,c0,Array< Float >,A0,Array< ::Dynamic >,scale,Array< Float >,A1,Array< Float >,w0,Array< ::Dynamic >,startCaps,Array< bool >,pixelHint)
					Void run(::flash::display::Graphics g,Float f){
						...
						{
							HX_STACK_LINE(747)
							g->lineStyle((w0->__get((int)0) + (((w1->__get((int)0) - w0->__get((int)0))) * f)),::format::swf::symbol::MorphShape_obj::interpolateColor(c0->__get((int)0),c1->__get((int)0),f),(A0->__get((int)0) + (((A1->__get((int)0) - A0->__get((int)0))) * f)),pixelHint->__get((int)0),scale->__get((int)0).StaticCast< ::flash::display::LineScaleMode >(),startCaps->__get((int)0).StaticCast< ::flash::display::CapsStyle >(),joints->__get((int)0).StaticCast< ::flash::display::JointStyle >(),miter->__get((int)0));
						}
						return null();
					}
					HX_END_LOCAL_FUNC2((void))
					...
					HX_STACK_LINE(747)
					result->__Field(HX_CSTRING("push"),true)( Dynamic(new _Function_5_1(c1,miter,w1,joints,c0,A0,scale,A1,w0,startCaps,pixelHint)));
				}
				else{
					HX_STACK_LINE(755)
					...
					if (((((int(fill) & int((int)16))) != (int)0))){
						...
						HX_BEGIN_LOCAL_FUNC_S9(hx::LocalFunc,_Function_6_1,Array< ::Dynamic >,ratios0,Array< int >,numColors,Array< ::Dynamic >,colors1,Array< ::Dynamic >,colors0,Array< ::Dynamic >,alphas1,Array< ::Dynamic >,matrix1,Array< ::Dynamic >,alphas0,Array< ::Dynamic >,ratios1,Array< ::Dynamic >,matrix0)
						Void run(::flash::display::Graphics g,Float f){
							...
							HX_STACK_ARG(f,"f");
							{
								...
								HX_STACK_LINE(809)
								g->lineGradientStyle(::flash::display::GradientType_obj::LINEAR,cols,alphas,ratios,::format::swf::symbol::MorphShape_obj::interpolateMatrix(matrix0->__get((int)0).StaticCast< ::flash::geom::Matrix >(),matrix1->__get((int)0).StaticCast< ::flash::geom::Matrix >(),f),null(),null(),null());
							}
							return null();
						}
						HX_END_LOCAL_FUNC2((void))
						...
						HX_STACK_LINE(795)
						result->__Field(HX_CSTRING("push"),true)( Dynamic(new _Function_6_1(ratios0,numColors,colors1,colors0,alphas1,matrix1,alphas0,ratios1,matrix0)));
					}
					else{
						HX_STACK_LINE(813)
	...
	HX_STACK_LINE(494)
	{
		...
		while(((_g < count))){
			...
			if (((fill == ::format::swf::symbol::MorphShape_obj::ftSolid))){
				...
				HX_BEGIN_LOCAL_FUNC_S4(hx::LocalFunc,_Function_4_1,Array< int >,RGB1,Array< Float >,dA,Array< int >,RGB0,Array< Float >,A0)
				Void run(::flash::display::Graphics g,Float f){
				...
				HX_STACK_LINE(506)
				result->__Field(HX_CSTRING("push"),true)( Dynamic(new _Function_4_1(RGB1,dA,RGB0,A0)));
			}
			else{
				HX_STACK_LINE(512)
				if (((((int(fill) & int((int)16))) != (int)0))){
					...
					HX_BEGIN_LOCAL_FUNC_S9(hx::LocalFunc,_Function_5_1,Array< ::Dynamic >,ratios0,Array< int >,numColors,Array< ::Dynamic >,colors1,Array< ::Dynamic >,colors0,Array< ::Dynamic >,alphas1,Array< ::Dynamic >,matrix1,Array< ::Dynamic >,alphas0,Array< ::Dynamic >,ratios1,Array< ::Dynamic >,matrix0)
					Void run(::flash::display::Graphics g,Float f){
						...
						HX_STACK_ARG(f,"f");
						{
							...
							HX_STACK_LINE(565)
							g->beginGradientFill(::flash::display::GradientType_obj::LINEAR,cols,alphas,ratios,::format::swf::symbol::MorphShape_obj::interpolateMatrix(matrix0->__get((int)0).StaticCast< ::flash::geom::Matrix >(),matrix1->__get((int)0).StaticCast< ::flash::geom::Matrix >(),f),null(),null(),null());
						}
						return null();
					}
					HX_END_LOCAL_FUNC2((void))
					...
					HX_STACK_LINE(551)
					result->__Field(HX_CSTRING("push"),true)( Dynamic(new _Function_5_1(ratios0,numColors,colors1,colors0,alphas1,matrix1,alphas0,ratios1,matrix0)));
				}
				else{
					HX_STACK_LINE(569)
						...
						if (((id->__get((int)0) != (int)65535))){
							...
							HX_STACK_LINE(578)
							{
								...
								switch((_switch_3)->GetIndex()){
									case 3: {
										::format::swf::symbol::Bitmap data = _switch_3->__Param(0);
{
											HX_STACK_LINE(580)
											bitmap[(int)0] = data->bitmapData;
										}
									}
									;break;
									default: {
						...
						Array< ::Dynamic > matrix0 = Array_obj< ::Dynamic >::__new().Add(stream->readMatrix());		HX_STACK_VAR(matrix0,"matrix0");
						HX_STACK_LINE(597)
						hx::MultEq(matrix0->__get((int)0).StaticCast< ::flash::geom::Matrix >()->a,0.05);
						HX_STACK_LINE(598)
						hx::MultEq(matrix0->__get((int)0).StaticCast< ::flash::geom::Matrix >()->b,0.05);
						HX_STACK_LINE(599)
						hx::MultEq(matrix0->__get((int)0).StaticCast< ::flash::geom::Matrix >()->c,0.05);
						HX_STACK_LINE(600)
						hx::MultEq(matrix0->__get((int)0).StaticCast< ::flash::geom::Matrix >()->d,0.05);
						HX_STACK_LINE(602)
						stream->alignBits();
						HX_STACK_LINE(604)
						Array< ::Dynamic > matrix1 = Array_obj< ::Dynamic >::__new().Add(stream->readMatrix());		HX_STACK_VAR(matrix1,"matrix1");
						HX_STACK_LINE(608)
						hx::MultEq(matrix1->__get((int)0).StaticCast< ::flash::geom::Matrix >()->a,0.05);
						HX_STACK_LINE(609)
						hx::MultEq(matrix1->__get((int)0).StaticCast< ::flash::geom::Matrix >()->b,0.05);
						HX_STACK_LINE(610)
						hx::MultEq(matrix1->__get((int)0).StaticCast< ::flash::geom::Matrix >()->c,0.05);
						HX_STACK_LINE(611)
						hx::MultEq(matrix1->__get((int)0).StaticCast< ::flash::geom::Matrix >()->d,0.05);
						HX_STACK_LINE(613)
						stream->alignBits();
						HX_STACK_LINE(618)
						if (((bitmap->__get((int)0).StaticCast< ::flash::display::BitmapData >() != null()))){

							HX_BEGIN_LOCAL_FUNC_S3(hx::LocalFunc,_Function_7_1,Array< ::Dynamic >,bitmap,Array< ::Dynamic >,matrix1,Array< ::Dynamic >,matrix0)
							Void run(::flash::display::Graphics g,Float f){
								...
								{
									HX_STACK_LINE(620)
									g->beginBitmapFill(bitmap->__get((int)0).StaticCast< ::flash::display::BitmapData >(),::format::swf::symbol::MorphShape_obj::interpolateMatrix(matrix0->__get((int)0).StaticCast< ::flash::geom::Matrix >(),matrix1->__get((int)0).StaticCast< ::flash::geom::Matrix >(),f),null(),null());
								}
								return null();
							}
							HX_END_LOCAL_FUNC2((void))
							...
							HX_STACK_LINE(618)
							result->__Field(HX_CSTRING("push"),true)( Dynamic(new _Function_7_1(bitmap,matrix1,matrix0)));
						}
						else{
							HX_STACK_LINE(630)
							...
							HX_BEGIN_LOCAL_FUNC_S6(hx::LocalFunc,_Function_7_1,Array< ::Dynamic >,s,Array< ::Dynamic >,bitmap,Array< ::Dynamic >,me,Array< ::Dynamic >,matrix1,Array< int >,id,Array< ::Dynamic >,matrix0)
							Void run(::flash::display::Graphics g,Float f){
										...
										if (((id->__get((int)0) != (int)65535))){
											...
											HX_STACK_LINE(639)
											{
												...
												switch((_switch_4)->GetIndex()){
													case 3: {
														::format::swf::symbol::Bitmap data = _switch_4->__Param(0);
{
															HX_STACK_LINE(641)
															bitmap[(int)0] = data->bitmapData;
														}
							...
							HX_STACK_LINE(633)
							result->__Field(HX_CSTRING("push"),true)( Dynamic(new _Function_7_1(s,bitmap,me,matrix1,id,matrix0)));
						}
					}
				}
			}
...
::flash::geom::Matrix MorphShape_obj::interpolateMatrix( ::flash::geom::Matrix matrix0,::flash::geom::Matrix matrix1,Float f){
...
Dynamic MorphShape_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 7:
		...
		if (HX_FIELD_EQ(inName,"bounds1") ) { bounds1=inValue.Cast< ::flash::geom::Rectangle >(); return inValue; }
		if (HX_FIELD_EQ(inName,"bounds0") ) { bounds0=inValue.Cast< ::flash::geom::Rectangle >(); return inValue; }
		break;
	case 8:
	...
	case 9:
		...
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"edgeBounds1") ) { edgeBounds1=inValue.Cast< ::flash::geom::Rectangle >(); return inValue; }
		if (HX_FIELD_EQ(inName,"edgeBounds0") ) { edgeBounds0=inValue.Cast< ::flash::geom::Rectangle >(); return inValue; }
		break;
	case 12:
