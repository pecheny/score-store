	...
	HX_STACK_LINE(28)
	{
		...
		while(((_g < count))){
			...
			struct _Function_3_1{
				inline static ::flash::filters::BitmapFilter Block( int &i,::format::swf::data::SWFStream &stream,int &count,int &filterID){
			...
			HX_STACK_LINE(32)
			filters->push(_Function_3_1::Block(i,stream,count,filterID));
		}
	}
	HX_STACK_LINE(50)
	return filters;
...
::flash::filters::BitmapFilter Filters_obj::createBevelFilter( ::format::swf::data::SWFStream stream){
...
::flash::filters::BitmapFilter Filters_obj::createBlurFilter( ::format::swf::data::SWFStream stream){
	...
	HX_STACK_LINE(112)
	return ::flash::filters::BlurFilter_obj::__new(blurX,blurY,passes);
}


STATIC_HX_DEFINE_DYNAMIC_FUNC1(Filters_obj,createBlurFilter,return )

::flash::filters::BitmapFilter Filters_obj::createColorMatrixFilter( ::format::swf::data::SWFStream stream){
...
::flash::filters::BitmapFilter Filters_obj::createConvolutionFilter( ::format::swf::data::SWFStream stream){
...
::flash::filters::BitmapFilter Filters_obj::createDropShadowFilter( ::format::swf::data::SWFStream stream){
	...
	int passes = stream->readBits((int)5,null());		HX_STACK_VAR(passes,"passes");
	HX_STACK_LINE(191)
	return ::flash::filters::DropShadowFilter_obj::__new(distance,angle,color,alpha,blurX,blurY,strength,passes,innerShadow,knockout,null());
}


STATIC_HX_DEFINE_DYNAMIC_FUNC1(Filters_obj,createDropShadowFilter,return )

::flash::filters::BitmapFilter Filters_obj::createGlowFilter( ::format::swf::data::SWFStream stream){
	...
	int passes = stream->readBits((int)5,null());		HX_STACK_VAR(passes,"passes");
	HX_STACK_LINE(212)
	return ::flash::filters::GlowFilter_obj::__new(color,alpha,blurX,blurY,strength,passes,innerGlow,knockout);
}


STATIC_HX_DEFINE_DYNAMIC_FUNC1(Filters_obj,createGlowFilter,return )

::flash::filters::BitmapFilter Filters_obj::createGradientBevelFilter( ::format::swf::data::SWFStream stream){
...
::flash::filters::BitmapFilter Filters_obj::createGradientGlowFilter( ::format::swf::data::SWFStream stream){
