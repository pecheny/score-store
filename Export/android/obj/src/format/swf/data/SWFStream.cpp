...
Void SWFStream_obj::__construct(::flash::utils::ByteArray bytes)
{
HX_STACK_PUSH("SWFStream::new","format/swf/data/SWFStream.hx",33);
{
	...
	struct _Function_1_1{
		inline static int Block( ::format::swf::data::SWFStream_obj *__this){
			...
			{
				HX_STACK_LINE(40)
				::flash::utils::ByteArray _this = __this->stream;		HX_STACK_VAR(_this,"_this");
				HX_STACK_LINE(40)
				return (  (((_this->position < _this->length))) ? int(_this->b->__get((_this->position)++)) : int(_this->__throwEOFi()) );
			}
			return null();
		}
	};
	...
	if (((signature == HX_CSTRING("CWS")))){
		HX_STACK_LINE(55)
		::flash::utils::ByteArray buffer = ::flash::utils::ByteArray_obj::__new(null());		HX_STACK_VAR(buffer,"buffer");
		HX_STACK_LINE(56)
...
hx::ObjectPtr< SWFStream_obj > SWFStream_obj::__new(::flash::utils::ByteArray bytes)
...
::flash::display::SpreadMethod SWFStream_obj::readSpreadMethod( ){
	...
	HX_STACK_LINE(551)
	{
		...
		switch( (int)(_g)){
			case (int)0: {
				HX_STACK_LINE(553)
				return ::flash::display::SpreadMethod_obj::PAD;
			}
			;break;
			case (int)1: {
				HX_STACK_LINE(554)
				return ::flash::display::SpreadMethod_obj::REFLECT;
			}
			;break;
			case (int)2: {
				HX_STACK_LINE(555)
				return ::flash::display::SpreadMethod_obj::REPEAT;
			}
			;break;
			case (int)3: {
				HX_STACK_LINE(556)
...
::flash::display::LineScaleMode SWFStream_obj::readScaleMode( ){
	...
	HX_STACK_LINE(520)
	{
		...
		switch( (int)(_g)){
			case (int)0: {
				HX_STACK_LINE(522)
				return ::flash::display::LineScaleMode_obj::NORMAL;
			}
			;break;
			case (int)1: {
				HX_STACK_LINE(523)
				return ::flash::display::LineScaleMode_obj::HORIZONTAL;
			}
			;break;
			case (int)2: {
				HX_STACK_LINE(524)
				return ::flash::display::LineScaleMode_obj::VERTICAL;
			}
			;break;
			case (int)3: {
				HX_STACK_LINE(525)
				return ::flash::display::LineScaleMode_obj::NONE;
			}
			;break;
		}
	}
...
::flash::geom::Rectangle SWFStream_obj::readRect( ){
...
::flash::geom::Matrix SWFStream_obj::readMatrix( ){
...
::flash::display::JointStyle SWFStream_obj::readJoinStyle( ){
	...
	HX_STACK_LINE(428)
	{
		...
		switch( (int)(_g)){
			case (int)0: {
				HX_STACK_LINE(430)
				return ::flash::display::JointStyle_obj::ROUND;
			}
			;break;
			case (int)1: {
				HX_STACK_LINE(431)
				return ::flash::display::JointStyle_obj::BEVEL;
			}
			;break;
			case (int)2: {
				HX_STACK_LINE(432)
				return ::flash::display::JointStyle_obj::MITER;
			}
			;break;
		}
	}
...
::flash::display::InterpolationMethod SWFStream_obj::readInterpolationMethod( ){
	...
	HX_STACK_LINE(414)
	{
		...
		switch( (int)(_g)){
			case (int)0: {
				HX_STACK_LINE(416)
				return ::flash::display::InterpolationMethod_obj::RGB;
			}
			;break;
			case (int)1: {
				HX_STACK_LINE(417)
				return ::flash::display::InterpolationMethod_obj::LINEAR_RGB;
			}
			;break;
		}
	}
...
::flash::utils::ByteArray SWFStream_obj::readFlashBytes( int length){
	HX_STACK_PUSH("SWFStream::readFlashBytes","format/swf/data/SWFStream.hx",363);
	HX_STACK_THIS(this);
	HX_STACK_ARG(length,"length");
	HX_STACK_LINE(365)
	::flash::utils::ByteArray bytes = ::flash::utils::ByteArray_obj::__new(null());		HX_STACK_VAR(bytes,"bytes");
	HX_STACK_LINE(366)
...
::flash::geom::ColorTransform SWFStream_obj::readColorTransform( bool withAlpha){
	...
	this->alignBits();
	HX_STACK_LINE(278)
	::flash::geom::ColorTransform result = ::flash::geom::ColorTransform_obj::__new(null(),null(),null(),null(),null(),null(),null(),null());		HX_STACK_VAR(result,"result");
	HX_STACK_LINE(280)
...
::flash::display::CapsStyle SWFStream_obj::readCapsStyle( ){
	...
	HX_STACK_LINE(261)
	{
		...
		switch( (int)(_g)){
			case (int)0: {
				HX_STACK_LINE(263)
				return ::flash::display::CapsStyle_obj::ROUND;
			}
			;break;
			case (int)1: {
				HX_STACK_LINE(264)
				return ::flash::display::CapsStyle_obj::NONE;
			}
			;break;
			case (int)2: {
				HX_STACK_LINE(265)
				return ::flash::display::CapsStyle_obj::SQUARE;
			}
			;break;
		}
	}
...
::flash::utils::ByteArray SWFStream_obj::readBytes( int length){
...
Void SWFStream_obj::endTag( ){
{
		...
		while(((read < size))){
			...
			{
				HX_STACK_LINE(118)
				::flash::utils::ByteArray _this = this->stream;		HX_STACK_VAR(_this,"_this");
				HX_STACK_LINE(118)
...
Dynamic SWFStream_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 6:
		if (HX_FIELD_EQ(inName,"stream") ) { stream=inValue.Cast< ::flash::utils::ByteArray >(); return inValue; }
		break;
	case 7:
