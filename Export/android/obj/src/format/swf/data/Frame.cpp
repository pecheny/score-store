...
Void Frame_obj::place( int symbolID,::format::swf::symbol::Symbol symbol,int depth,::flash::geom::Matrix matrix,::flash::geom::ColorTransform colorTransform,Dynamic ratio,::String name,Array< ::Dynamic > filters){
{
...
Void Frame_obj::move( int depth,::flash::geom::Matrix matrix,::flash::geom::ColorTransform colorTransform,Dynamic ratio){
{
